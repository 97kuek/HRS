              ...
              [
                ...
                (() => {
                  const nights = Math.round(
                    (new Date(result.checkOutDate).getTime() - new Date(result.checkInDate).getTime()) / 86400000,
                  );
                  return `${result.checkInDate} 〜 ${result.checkOutDate}（${nights}泊・${result.guestCount}名）`;
                })(),
              ],
            ].map(([label, value]) => (
          ...
          <div className="confirm-table">
            {[
              ...
              [
                ...
                (() => {
                  const nights = Math.round(
                    (new Date(quote.checkOutDate).getTime() - new Date(quote.checkInDate).getTime()) / 86400000,
                  );
                  return `${quote.checkInDate} 〜 ${quote.checkOutDate}（${nights}泊・${quote.guestCount}名）`;
                })(),
              ],
            ].map(([label, value]) => (
              <div key={label} className="confirm-row">
