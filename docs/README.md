...
| 成果物                                                                                                        | 説明                                              |
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [usecase-diagram.png](analysis/requirements/usecase-diagram.png)                                                | ユースケース図                                    |
| [usecase-diagram.md](analysis/requirements/usecase-diagram.md)                                                | ユースケース図の説明・アクター・スコープ          |
| [usecase-description-reserve-room.md](analysis/requirements/usecase-description-reserve-room.md)                | UC「部屋を予約する」のユースケース記述            |
| [activity-diagram-reserve-room.png](analysis/requirements/activity-diagram-reserve-room.png)              | UC「部屋を予約する」のアクティビティ図            |
| [usecase-description-confirm-reservation.md](analysis/requirements/usecase-description-confirm-reservation.md)                | UC「予約を確認する」のユースケース記述            |
| [activity-diagram-confirm-reservation.png](analysis/requirements/activity-diagram-confirm-reservation.png)              | UC「予約を確認する」のアクティビティ図            |
| [usecase-description-check-in.md](analysis/requirements/usecase-description-check-in.md)            | UC「チェックインする」のユースケース記述          |
| [activity-diagram-check-in.png](analysis/requirements/activity-diagram-check-in.png)          | UC「チェックインする」のアクティビティ図          |
| [usecase-description-check-out.md](analysis/requirements/usecase-description-check-out.md)        | UC「チェックアウトする」のユースケース記述        |
| [activity-diagram-check-out.png](analysis/requirements/activity-diagram-check-out.png)      | UC「チェックアウトする」のアクティビティ図        |
| [usecase-description-cancel-reservation.md](analysis/requirements/usecase-description-cancel-reservation.md)    | UC「予約をキャンセルする」のユースケース記述      |
| [activity-diagram-cancel-reservation.png](analysis/requirements/activity-diagram-cancel-reservation.png)  | UC「予約をキャンセルする」のアクティビティ図      |
| [acceptance-test-checklist.md](analysis/requirements/acceptance-test-checklist.md)                           | 受入テストの手動確認チェックリスト                |

### ユースケース図

![ユースケース図](analysis/requirements/usecase-diagram.png)

### アクティビティ図 — 部屋を予約する

![activity-diagram-reserve-room](analysis/requirements/activity-diagram-reserve-room.png)

### アクティビティ図 — 予約を確認する

![activity-diagram-confirm-reservation](analysis/requirements/activity-diagram-confirm-reservation.png)

### アクティビティ図 — チェックインする

![activity-diagram-check-in](analysis/requirements/activity-diagram-check-in.png)

### アクティビティ図 — チェックアウトする

![activity-diagram-check-out](analysis/requirements/activity-diagram-check-out.png)

### アクティビティ図 — 予約をキャンセルする

![activity-diagram-cancel-reservation](analysis/requirements/activity-diagram-cancel-reservation.png)
...
| 部屋を予約する       | —                                                                                              | [collaboration-diagram-reserve-room.asta](analysis/system/collaboration-diagram-reserve-room.asta)                          | [collaboration-diagram-reserve-room.png](analysis/system/collaboration-diagram-reserve-room.png)                          |
| チェックインする     | [説明](analysis/system/collaboration-diagram-check-in.md)                                 | [collaboration-diagram-check-in.asta](analysis/system/collaboration-diagram-check-in.asta)                      | [collaboration-diagram-check-in.png](analysis/system/collaboration-diagram-check-in.png)                      |
| チェックアウトする   | [説明](analysis/system/collaboration-diagram-check-out.md)                               | [collaboration-diagram-check-out.asta](analysis/system/collaboration-diagram-check-out.asta)                  | [collaboration-diagram-check-out.png](analysis/system/collaboration-diagram-check-out.png)                  |
| 予約をキャンセルする | [保守記録](analysis/system/37-maintenance-reservation-cancellation.md)                            | [collaboration-diagram-cancel-reservation.asta](analysis/system/collaboration-diagram-cancel-reservation.asta)              | [collaboration-diagram-cancel-reservation.png](analysis/system/collaboration-diagram-cancel-reservation.png)              |

### 補足資料

| ファイル                                                                                             | 内容                              |
| ---------------------------------------------------------------------------------------------------- | --------------------------------- |
| [17-maintenance-ui-ux-improvement.md](analysis/system/17-maintenance-ui-ux-improvement.md)                                        | UI/UX改善による分析・設計への影響 |
| [37-maintenance-reservation-cancellation.md](analysis/system/37-maintenance-reservation-cancellation.md)  | 予約キャンセル追加時の差分        |
...
![collaboration-diagram-reserve-room](analysis/system/collaboration-diagram-reserve-room.png)

### コラボレーション図 — チェックインする

![collaboration-diagram-check-in](analysis/system/collaboration-diagram-check-in.png)

### コラボレーション図 — チェックアウトする

![collaboration-diagram-check-out](analysis/system/collaboration-diagram-check-out.png)

### コラボレーション図 — 予約をキャンセルする

![collaboration-diagram-cancel-reservation](analysis/system/collaboration-diagram-cancel-reservation.png)
